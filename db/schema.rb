...
ActiveRecord::Schema.define(version: 2022_02_04_074236) do
  ...
  create_table "code_newors", force: :cascade do |t|
    t.string "name"
    t.string "priority"
    t.string "content"
    t.json "ref", default: "{}"
  ...
  create_table "code_paymethods", force: :cascade do |t|
    t.string "name"
    t.string "priority"
    t.string "content"
    t.string "memo"
